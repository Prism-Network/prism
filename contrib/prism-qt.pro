...
RESOURCES += src/qt/prism.qrc src/qt/prism_locale.qrc

TRANSLATIONS += src/qt/locale/prism_bg.ts \
                src/qt/locale/prism_de.ts \
                src/qt/locale/prism_en.ts \
                src/qt/locale/prism_es.ts \
                src/qt/locale/prism_fi.ts \
                src/qt/locale/prism_fr.ts \
                src/qt/locale/prism_it.ts \
                src/qt/locale/prism_ja.ts \
                src/qt/locale/prism_pl.ts \
                src/qt/locale/prism_pt.ts \
                src/qt/locale/prism_ru.ts \
                src/qt/locale/prism_sk.ts \
                src/qt/locale/prism_sv.ts \
                src/qt/locale/prism_vi.ts \
                src/qt/locale/prism_zh_CN.ts \
                src/qt/locale/prism_zh_TW.ts
