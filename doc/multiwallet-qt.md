...
In order to support loading of multiple wallets in prism-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prism.cpp.
...
Changes to prism.cpp
----------------------
prism.cpp is the entry point into prism-qt, and as such, will require some minor modifications to provide hooks for
