...
This mechanism has been integrated into Bitcore-Node-LUM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LUM-Project/insight-api-prism#web-socket-api](https://github.com/LUM-Project/insight-api-prism#web-socket-api) 
* API: [https://github.com/LUM-Project/insight-api-prism#swifttx-transactions](https://github.com/LUM-Project/insight-api-prism#swifttx-transactions) 
...
By default, the Prism Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Prism Core daemon:
