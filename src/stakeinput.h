...
#ifndef LUM_STAKEINPUT_H
#define LUM_STAKEINPUT_H
...
public:
    ...
    virtual bool IszLUM() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zLUMStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zlum, which is a zcspend that has successfully staked
...
public:
    ...
    bool IszLUM() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IszLUM() override { return false; }
};


#endif //LUM_STAKEINPUT_H
