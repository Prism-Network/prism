...
extern UniValue setzlumseed(const UniValue& params, bool fHelp);
extern UniValue getzlumseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlum(const UniValue& params, bool fHelp);
extern UniValue dzlumstate(const UniValue& params, bool fHelp);
