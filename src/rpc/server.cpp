...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LUM features */
        {"prism", "masternode", &masternode, true, true, false},
        {"prism", "listmasternodes", &listmasternodes, true, true, false},
        {"prism", "getmasternodecount", &getmasternodecount, true, true, false},
        {"prism", "masternodeconnect", &masternodeconnect, true, true, false},
        {"prism", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"prism", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"prism", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"prism", "masternodecurrent", &masternodecurrent, true, true, false},
        {"prism", "masternodedebug", &masternodedebug, true, true, false},
        {"prism", "startmasternode", &startmasternode, true, true, false},
        {"prism", "createmasternodekey", &createmasternodekey, true, true, false},
        {"prism", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"prism", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"prism", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"prism", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"prism", "getmasternodescores", &getmasternodescores, true, true, false},
        {"prism", "mnbudget", &mnbudget, true, true, false},
        {"prism", "preparebudget", &preparebudget, true, true, false},
        {"prism", "submitbudget", &submitbudget, true, true, false},
        {"prism", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"prism", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"prism", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"prism", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"prism", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"prism", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"prism", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"prism", "checkbudgets", &checkbudgets, true, true, false},
        {"prism", "mnsync", &mnsync, true, true, false},
        {"prism", "spork", &spork, true, true, false},
        {"prism", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzlumseed", &getzlumseed, false, false, true},
        {"zerocoin", "setzlumseed", &setzlumseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzlum", &searchdzlum, false, false, true},
        {"zerocoin", "dzlumstate", &dzlumstate, false, false, true}
...
{
    return "> prism-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31473/\n";
}
