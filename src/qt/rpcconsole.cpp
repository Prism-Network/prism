                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLUMPathCustom = GetArg("-zlumbackuppath", "");
    ...
    if(!strzLUMPathCustom.empty()) {
        ui->wallet_customzlumbackuppath->setText(QString::fromStdString(strzLUMPathCustom));
        ui->wallet_customzlumbackuppath_label->setVisible(true);
        ui->wallet_customzlumbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLUMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the LUM RPC console.") + "<br>" +
