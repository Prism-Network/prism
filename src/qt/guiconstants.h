...
/* BitCoinOne GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LUM"
#define QAPP_ORG_DOMAIN "prism.org"
#define QAPP_APP_NAME_DEFAULT "Prism-Qt"
#define QAPP_APP_NAME_TESTNET "Prism-Qt-testnet"
