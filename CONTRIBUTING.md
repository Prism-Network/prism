Contributing to Prism Core
============================

The Prism Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Prism Core project, and is not to be
confused with overall LUM Network Protocol consensus changes.

Whether a pull request is merged into Prism Core rests with the project merge
...
Patches that change LUM consensus rules are considerably more involved than
...
Where a patch set proposes to change the LUM consensus, it must have been
...
The project leader is the release manager for each Prism Core release.
