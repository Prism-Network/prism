...
#   c) node1 mines 32 blocks, so now node 0 has 60001lum, node 1 has 4250lum, node2 has none.
#   d) node0 sends 601 lum to node2, in two transactions (301 lum, then 300 lum).
